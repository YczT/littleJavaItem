...
public class CategoryController {
     ...
     */
    @PostMapping
    public R<String> save(@RequestBody Category category) {//因为传过来的是JSON形式，加注解RequestBody才可以获取到
...
//        LambdaQueryWrapper<Category> queryWrapper = new LambdaQueryWrapper<>();
//        queryWrapper.eq(Category::getIsDeleted, category.getIsDeleted());
//        Category cat = categoryService.getOne(queryWrapper);
//        if (cat.getIsDeleted() == 1) {
//
//        }
