...
import com.itheima.riggie.mapper.OrderMapper;
import com.itheima.riggie.service.*;
...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, Orders> implements OrderService {
    ...
    public void submit(Orders orders) {
        ...
        AtomicInteger amount=new AtomicInteger(0); //原子整型
        ...
        orders.setStatus(2);
        orders.setAmount(new BigDecimal(amount.get()));//计算总金额(防止浮点数计算出现错误)
